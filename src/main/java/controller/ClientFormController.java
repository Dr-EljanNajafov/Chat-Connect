...
public class ClientFormController {
    ...
    private void sendMsg(String msgToSend) {
        if (!msgToSend.isEmpty()){
            if (!msgToSend.matches(".*\\.(png|jpe?g|gif)$")){
                ...
                textFlow.setStyle("-fx-background-color: #808080; -fx-font-weight: bold; -fx-color: white; -fx-background-radius: 20px");
    ...
    public static void receiveMessage(String msg, VBox vBox) throws IOException {
        if (msg.matches(".*\\.(png|jpe?g|gif)$")){
            ...
            TextFlow textFlow = new TextFlow(text);
            textFlow.setStyle("-fx-background-color: #999999; -fx-font-weight: bold; -fx-background-radius: 20px");
            textFlow.setPadding(new Insets(5,10,5,10));
